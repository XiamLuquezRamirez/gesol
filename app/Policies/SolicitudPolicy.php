...
class SolicitudPolicy
{
     ...
     * de su comision de viaticos en cualquier estado salvo cancelada. Si la comision
     * ya esta cerrada, el ajuste queda como anexo (no reabre ni exige reliquidacion).
     */
